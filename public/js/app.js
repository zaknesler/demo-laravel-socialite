...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_slide_up_down__ = __webpack_require__(37);




Vue.component('slide', __WEBPACK_IMPORTED_MODULE_1_vue_slide_up_down__["a" /* default */]);

Vue.component('example-component', __webpack_require__(38));

Vue.component('passport-secret', __webpack_require__(41));
...
Component.options.__file = "resources\\assets\\js\\components\\passport\\Secret.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-24535a5a", Component.options)
  } else {
    hotAPI.reload("data-v-24535a5a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "flex items-baseline" }, [
    _c("div", {
      directives: [
        {
          name: "show",
    ...
    _vm._v(" "),
    _c("a", {
      staticClass: "cursor-pointer text-blue no-underline hover:underline",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-24535a5a", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getClients: function getClients() {
            ...
            axios.get('/oauth/clients').then(function (_ref) {
                var data = _ref.data;
         ...
         */
        toggleCreateClientForm: function toggleCreateClientForm() {
        ...
        persistClient: function persistClient(method, uri, form, modal) {
            ...
            axios[method](uri, form).then(function () {
                _this2.getClients();
...
var render = function() {
  ...
  return _c("div", [
    _c("div", [
      _c("div", { staticClass: "border-b pb-2 mb-4" }, [
        _c("div", { staticClass: "flex items-center justify-between" }, [
          _c(
            "span",
            {
              staticClass: "text-sm uppercase tracking-wide font-semibold mr-4"
            },
          ...
          _c(
            ...
            {
              staticClass:
                "text-sm font-semibold cursor-pointer text-blue no-underline hover:underline",
              on: { click: _vm.toggleCreateClientForm }
            },
            [_vm._v("Create New")]
          )
        ]),
                  ...
                  directives: [
                    {
                      name: "show",
                      rawName: "v-show",
                      value: _vm.createForm.errors.length > 0,
                      expression: "createForm.errors.length > 0"
                    }
                  ],
                  staticClass:
                    "mb-2 bg-red-lightest rounded p-3 text-sm text-red"
                },
                [
                  _c(
                    "ul",
                    { staticClass: "ml-3 pl-3" },
              ...
              _c("div", { staticClass: "flex" }, [
                _c("div", { staticClass: "mr-2" }, [
                  _c("input", {
                    ...
                    staticClass:
                      "appearance-none w-full h-full border p-2 rounded text-sm text-grey-darker focus:outline-none focus:border-blue",
                ...
                _c("div", { staticClass: "flex-1 mr-2" }, [
                  _c("input", {
                    ...
                    staticClass:
                      "appearance-none w-full h-full border p-2 rounded text-sm text-grey-darker focus:outline-none focus:border-blue",
                    attrs: { placeholder: "Redirect URL", type: "text" },
                ...
                _c("div", [
                  _c(
                    ...
                    {
                      staticClass:
                        "block appearance-none h-full rounded text-sm bg-blue hover:bg-blue-dark text-white px-4 py-2",
                      attrs: { type: "submit" },
                      on: {
                        click: function($event) {
                          $event.preventDefault()
      ...
      _c("div", [
        !_vm.clients.length
          ? _c("p", [_vm._v("You have not created any clients.")])
          : _c("div", [
              _c(
                "div",
                { staticClass: "-mb-6" },
                _vm._l(_vm.clients, function(client) {
                  return _c(
                    ...
                    {
                      staticClass:
                        "border border-grey-lighter bg-grey-lightest rounded flex flex-col lg:flex-row lg:justify-between p-3 mb-6"
                    },
                    [
                      _c("div", { staticClass: "mb-3 lg:mb-0" }, [
                        _c("div", {
                          staticClass: "font-semibold text-grey-darkest mb-3",
                          domProps: { textContent: _vm._s(client.name) }
                        }),
                        _vm._v(" "),
                        _c(
                          "div",
                          { staticClass: "flex items-baseline text-sm" },
                          [
                            _c(
                              "div",
                              {
                                staticClass:
                                  "font-semibold w-16 text-right flex-no-shrink"
                              },
                              [_vm._v("Client ID")]
                            ),
                            _vm._v(" "),
                            _c("div", {
                              staticClass: "ml-2 font-mono text-grey-dark",
                              domProps: { textContent: _vm._s(client.id) }
                            })
                          ]
                        ),
                        _vm._v(" "),
                        _c(
                          ...
                          [
                            ...
                            _c("div", {
                              staticClass: "ml-2 font-mono text-grey-dark",
                              domProps: { textContent: _vm._s(client.redirect) }
                            })
                          ]
                        ),
                        _vm._v(" "),
                        _c(
                          ...
                          {
                            staticClass:
                              "flex items-baseline text-sm break-words"
                          },
                          [
                            _c(
                              "div",
                            ...
                            _c(
                              ...
                              {
                                staticClass:
                                  "w-auto ml-2 font-mono text-grey-dark"
                              },
                              [
                                _c("passport-secret", {
                                  attrs: { text: client.secret }
                                })
                              ],
                              1
                            )
                      ...
                      _c(
                        ...
                        {
                          staticClass:
                            "flex-no-shrink lg:self-center flex items-center"
                        },
                        [
                          _c(
                            "a",
                            {
                              staticClass:
                                "text-sm border hover:border-grey bg-white rounded px-3 py-1 cursor-pointer no-underline mr-3",
                              on: {
                                click: function($event) {
                                  _vm.edit(client)
                                }
                          ...
                          _c(
                            ...
                            {
                              staticClass:
                                "text-sm border hover:border-grey bg-white rounded px-3 py-1 cursor-pointer no-underline",
                              on: {
                                click: function($event) {
                                  _vm.destroy(client)
                                }
        ...
        _vm._v(" "),
        _c("table", { staticClass: "hidden table" }, [
          _vm._m(0),
          _vm._v(" "),
          _c(
            "tbody",
              ...
              return _c("tr", [
                ...
                _c("td", { staticClass: "align-middle" }, [
                  _c(
                    ...
                    {
                      staticClass:
                        "font-mono border rounded bg-grey-lightest px-2 py-1"
                    },
                    [_vm._v(_vm._s(client.secret))]
                  )
                ]),
                _vm._v(" "),
                _c("td", { staticClass: "align-middle" }, [
            ...
            _c("div", { staticClass: "modal-header" }, [
              _c("a", {
                ...
                on: {
                  click: function($event) {
                    $event.preventDefault()
                    return _vm.closeEditClientModal($event)
                  }
                }
              }),
              _vm._v(" "),
...
var update = __webpack_require__(12)("437dd684", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(12)("174f2f0a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
