...
@section('title', 'Sign In with Email')
        ...
        <div class="m-auto max-w-sm w-full sm:px-8">
            <div class="m-8">
                ...
                <div class="bg-white rounded">
                    ...
                    <form class="w-full border border-t-0 rounded-b p-8" action="{{ route('auth.login.passwordless.send') }}" method="POST">
                        @csrf

                        <div class="text-lg text-grey-darkest text-center mb-8">Sign in with email address</div>
                        ...
                        <div class="block">
                            <input class="appearance-none w-full border-0 bg-blue hover:bg-blue-dark text-white rounded cursor-pointer p-3" type="submit" value="Send Link" />
                        </div>
                    </form>
                </div>
            </div>
