<ul class="list-reset -mb-3">
    ...
    <li><a class="block {{ Route::currentRouteIs('settings.privacy', 'border-blue text-blue bg-grey-lightest ') }} block border-l-4 border-white px-6 py-3 font-semibold text-grey-darker no-underline hover:underline" href="{{ route('settings.privacy') }}">Privacy</a></li>
